...
public class TimTerm {
	...
	public static void main(String[] args) {
		...
		bar.setUndecorated(true); // really, a JWindow should be used if it shouldn't show up in taskbar and should be undecorated. But JWindows can't have
									// editable components (?), so we do this.
